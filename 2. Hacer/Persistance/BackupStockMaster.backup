...
CREATE FUNCTION public."ActualizarCategoriaProducto"(p_idcategoriaproducto uuid, p_nombre character varying, p_descripcion character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."ActualizarCiudad"(p_idciudad uuid, p_iddepartamento uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Ciudad" 
...
CREATE FUNCTION public."ActualizarCliente"(p_idcliente uuid, p_idpersona uuid, p_fecharegistro date, p_direccion character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Cliente" 
...
CREATE FUNCTION public."ActualizarDepartamento"(p_iddepartamento uuid, p_idpais uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Departamento" 
...
CREATE FUNCTION public."ActualizarDetalleFactura"(p_iddetallefactura uuid, p_idfactura uuid, p_idproducto uuid, p_cantidad numeric, p_subtotal numeric) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."ActualizarEmpleado"(p_idempleado uuid, p_idpersona uuid, p_idsucursal uuid, p_fechacontratacion date, p_salario numeric) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Empleado" 
...
CREATE FUNCTION public."ActualizarEstadoFactura"(p_idestadofactura uuid, p_nombre character varying, p_descripcion character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."ActualizarFactura"(p_idfactura uuid, p_idestadofactura uuid, p_idmetodopago uuid, p_idempleado uuid, p_idcliente uuid, p_numerofactura character varying, p_fecha timestamp without time zone, p_total numeric, p_notas character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Factura" 
...
CREATE FUNCTION public."ActualizarGenero"(p_idgenero uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Genero" 
...
CREATE FUNCTION public."ActualizarMetodoPago"(p_idmetodopago uuid, p_nombre character varying, p_descripcion character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "MetodoPago" 
...
CREATE FUNCTION public."ActualizarPais"(p_idpais uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
	UPDATE "Pais" 
...
CREATE FUNCTION public."ActualizarProducto"(p_idproducto uuid, p_idtipoproducto uuid, p_nombre character varying, p_descripcion character varying, p_precio numeric, p_stock numeric) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Producto" 
...
CREATE FUNCTION public."ActualizarSucursal"(p_idsucursal uuid, p_idciudad uuid, p_idtienda uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Sucursal" 
...
CREATE FUNCTION public."ActualizarTienda"(p_idtienda uuid, p_nombre character varying, p_nit character varying, p_telefono character varying, p_correo character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Tienda" 
...
CREATE FUNCTION public."ActualizarTipoDocumento"(p_idtipodocumento uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."ActualizarTipoProducto"(p_idtipoproducto uuid, p_idcategoriaproducto uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "TipoProducto" 
...
--
-- Name: ConsultarCiudadPorNombre(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ConsultarCiudadPorNombre"(p_nombreciudad character varying) RETURNS TABLE("IdCiudad" uuid, "IdDepartamento" uuid, "Nombre" character varying, "Activo" bit, "Actualiza" timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY 
...
ALTER FUNCTION public."ConsultarCiudadPorNombre"(p_nombreciudad character varying) OWNER TO postgres;
...
--
-- Name: ConsultarClientePorNombre(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ConsultarClientePorNombre"(p_direccioncliente character varying) RETURNS TABLE("IdCliente" uuid, "IdPersona" uuid, "FechaRegistro" date, "Direccion" character varying, "Activo" bit, "Actualiza" timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY 
...
ALTER FUNCTION public."ConsultarClientePorNombre"(p_direccioncliente character varying) OWNER TO postgres;
...
--
-- Name: ConsultarDepartamentoPorNombre(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ConsultarDepartamentoPorNombre"(p_nombredepartamento character varying) RETURNS TABLE("IdDepartamento" uuid, "IdPais" uuid, "Nombre" character varying, "Activo" bit, "Actualiza" timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY 
...
ALTER FUNCTION public."ConsultarDepartamentoPorNombre"(p_nombredepartamento character varying) OWNER TO postgres;
...
--
-- Name: ConsultarGeneroPorNombre(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ConsultarGeneroPorNombre"(p_nombregenero character varying) RETURNS TABLE("IdGenero" uuid, "Nombre" character varying, "Activo" bit, "Actualiza" timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY 
...
ALTER FUNCTION public."ConsultarGeneroPorNombre"(p_nombregenero character varying) OWNER TO postgres;
...
--
-- Name: ConsultarPaisPorNombre(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ConsultarPaisPorNombre"(p_nombrepais character varying) RETURNS TABLE("IdPais" uuid, "Nombre" character varying, "Activo" bit, "Actualiza" timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY 
...
ALTER FUNCTION public."ConsultarPaisPorNombre"(p_nombrepais character varying) OWNER TO postgres;

--
-- Name: ConsultarPaisSP(); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public."ConsultarPaisSP"()
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER PROCEDURE public."ConsultarPaisSP"() OWNER TO postgres;
...
--
-- Name: ConsultarPersonaPorNombre(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ConsultarPersonaPorNombre"(p_nombrepersona character varying) RETURNS TABLE("IdPersona" uuid, "IdGenero" uuid, "IdTipoDocumento" uuid, "IdCiudad" uuid, "NombreCompleto" character varying, "NumeroDocumento" character varying, "Correo" character varying, "Telefono" character varying, "FechaNacimiento" date, "Usuario" character varying, "Contrasena" character varying, "Activo" bit, "Actualiza" timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY 
...
ALTER FUNCTION public."ConsultarPersonaPorNombre"(p_nombrepersona character varying) OWNER TO postgres;
...
--
-- Name: ConsultarTipoDocumentoPorNombre(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ConsultarTipoDocumentoPorNombre"(p_nombretipodocumento character varying) RETURNS TABLE("IdTipoDocumento" uuid, "Nombre" character varying, "Activo" bit, "Actualiza" timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY 
...
ALTER FUNCTION public."ConsultarTipoDocumentoPorNombre"(p_nombretipodocumento character varying) OWNER TO postgres;
...
CREATE FUNCTION public."EliminarCategoriaProducto"(p_idcategoriaproducto uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "CategoriaProducto" 
...
--
-- Name: EliminarCategoriaProductoFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarCategoriaProductoFisico"(p_idcategoriaproducto uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarCategoriaProductoFisico"(p_idcategoriaproducto uuid) OWNER TO postgres;

--
-- Name: EliminarCiudad(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarCiudad"(p_idciudad uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Ciudad" 
...
--
-- Name: EliminarCiudadFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarCiudadFisico"(p_idciudad uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    DELETE FROM "Ciudad" 
...
ALTER FUNCTION public."EliminarCiudadFisico"(p_idciudad uuid) OWNER TO postgres;

--
-- Name: EliminarCliente(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarCliente"(p_idcliente uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Cliente" 
...
--
-- Name: EliminarClienteFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarClienteFisico"(p_idcliente uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    DELETE FROM "Cliente" 
...
ALTER FUNCTION public."EliminarClienteFisico"(p_idcliente uuid) OWNER TO postgres;

--
-- Name: EliminarDepartamento(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarDepartamento"(p_iddepartamento uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Departamento" 
...
--
-- Name: EliminarDepartamentoFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarDepartamentoFisico"(p_iddepartamento uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarDepartamentoFisico"(p_iddepartamento uuid) OWNER TO postgres;

--
-- Name: EliminarDetalleFactura(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarDetalleFactura"(p_iddetallefactura uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "DetalleFactura" 
...
--
-- Name: EliminarDetalleFacturaFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarDetalleFacturaFisico"(p_iddetallefactura uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarDetalleFacturaFisico"(p_iddetallefactura uuid) OWNER TO postgres;

--
-- Name: EliminarEmpleado(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarEmpleado"(p_idempleado uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Empleado" 
...
--
-- Name: EliminarEmpleadoFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarEmpleadoFisico"(p_idempleado uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarEmpleadoFisico"(p_idempleado uuid) OWNER TO postgres;

--
-- Name: EliminarEstadoFactura(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarEstadoFactura"(p_idestadofactura uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "EstadoFactura" 
...
--
-- Name: EliminarEstadoFacturaFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarEstadoFacturaFisico"(p_idestadofactura uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarEstadoFacturaFisico"(p_idestadofactura uuid) OWNER TO postgres;

--
-- Name: EliminarFactura(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarFactura"(p_idfactura uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Factura" 
...
--
-- Name: EliminarFacturaFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarFacturaFisico"(p_idfactura uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    DELETE FROM "Factura" 
...
ALTER FUNCTION public."EliminarFacturaFisico"(p_idfactura uuid) OWNER TO postgres;

--
-- Name: EliminarGenero(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarGenero"(p_idgenero uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Genero" 
...
--
-- Name: EliminarGeneroFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarGeneroFisico"(p_idgenero uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    DELETE FROM "Genero" 
...
ALTER FUNCTION public."EliminarGeneroFisico"(p_idgenero uuid) OWNER TO postgres;

--
-- Name: EliminarMetodoPago(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarMetodoPago"(p_idmetodopago uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "MetodoPago" 
...
--
-- Name: EliminarMetodoPagoFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarMetodoPagoFisico"(p_idmetodopago uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarMetodoPagoFisico"(p_idmetodopago uuid) OWNER TO postgres;

--
-- Name: EliminarPais(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarPais"(p_idpais uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
	UPDATE "Pais" 
...
--
-- Name: EliminarPaisFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarPaisFisico"(p_idpais uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
	DELETE FROM "Pais"
...
ALTER FUNCTION public."EliminarPaisFisico"(p_idpais uuid) OWNER TO postgres;

--
-- Name: EliminarPersona(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarPersona"(p_idpersona uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Persona" 
...
--
-- Name: EliminarPersonaFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarPersonaFisico"(p_idpersona uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    DELETE FROM "Persona" 
...
ALTER FUNCTION public."EliminarPersonaFisico"(p_idpersona uuid) OWNER TO postgres;

--
-- Name: EliminarProducto(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarProducto"(p_idproducto uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Producto" 
...
--
-- Name: EliminarProductoFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarProductoFisico"(p_idproducto uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarProductoFisico"(p_idproducto uuid) OWNER TO postgres;

--
-- Name: EliminarSucursal(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarSucursal"(p_idsucursal uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Sucursal" 
...
--
-- Name: EliminarSucursalFisica(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarSucursalFisica"(p_idsucursal uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarSucursalFisica"(p_idsucursal uuid) OWNER TO postgres;

--
-- Name: EliminarTienda(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarTienda"(p_idtienda uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "Tienda" 
...
--
-- Name: EliminarTiendaFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarTiendaFisico"(p_idtienda uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    DELETE FROM "Tienda" 
...
ALTER FUNCTION public."EliminarTiendaFisico"(p_idtienda uuid) OWNER TO postgres;

--
-- Name: EliminarTipoDocumento(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarTipoDocumento"(p_idtipodocumento uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN 
    UPDATE "TipoDocumento" 
...
--
-- Name: EliminarTipoDocumentoFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarTipoDocumentoFisico"(p_idtipodocumento uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN 
...
ALTER FUNCTION public."EliminarTipoDocumentoFisico"(p_idtipodocumento uuid) OWNER TO postgres;

--
-- Name: EliminarTipoProducto(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarTipoProducto"(p_idtipoproducto uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    UPDATE "TipoProducto" 
...
--
-- Name: EliminarTipoProductoFisico(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."EliminarTipoProductoFisico"(p_idtipoproducto uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public."EliminarTipoProductoFisico"(p_idtipoproducto uuid) OWNER TO postgres;

--
-- Name: IngresarCategoriaProducto(character varying, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."IngresarCategoriaProducto"(p_nombre character varying, p_descripcion character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarCiudad"(p_iddepartamento uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarCliente"(p_idpersona uuid, p_fecharegistro date, p_direccion character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarDepartamento"(p_idpais uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarDetalleFactura"(p_idfactura uuid, p_idproducto uuid, p_cantidad numeric, p_subtotal numeric) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarEmpleado"(p_idpersona uuid, p_idsucursal uuid, p_fechacontratacion date, p_salario numeric) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarEstadoFactura"(p_nombre character varying, p_descripcion character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarFactura"(p_idestadofactura uuid, p_idmetodopago uuid, p_idempleado uuid, p_idcliente uuid, p_numerofactura character varying, p_fecha timestamp without time zone, p_total numeric, p_notas character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarGenero"(p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarMetodoPago"(p_nombre character varying, p_descripcion character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarPais"(p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarProducto"(p_idtipoproducto uuid, p_nombre character varying, p_descripcion character varying, p_precio numeric, p_stock numeric) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarSucursal"(p_idciudad uuid, p_idtienda uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarTienda"(p_nombre character varying, p_nit character varying, p_telefono character varying, p_correo character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarTipoDocumento"(p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
CREATE FUNCTION public."IngresarTipoProducto"(p_idcategoriaproducto uuid, p_nombre character varying) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
